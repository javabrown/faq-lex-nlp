...
rem aws lex-models put-slot-type --region us-east-1 --name iCWFAQSlotTypes --cli-input-json file://faq-slot-types.json
aws lex-models put-slot-type --region us-east-1 --name iCWFAQSlotTypes --cli-input-json file://parser/gen/slots.json
PING -n 1 127.0.0.1>nul

rem aws lex-models put-intent --region us-east-1 --name iCWFAQIntents --cli-input-json file://faq-intents.json
